      ...
      <div className="wrapper-page">
        <div className="card card-pages shadow-none">
          <div className="card-body">
            ...
            <form className="form-horizontal m-t-30" action="https://themesdesign.in/stexo/layouts/vertical/index.html">
              ...
              <div className="form-group row m-t-30 m-b-0">
                <div className="col-sm-7">
                  <a href="pages-recoverpw.html" className="text-muted"><i className="fa fa-lock m-r-5" /> Forgot your password?</a>
                </div>
