!(function () {
    ...
    function t() {
        var t = {
            ...
            dialogs: {
                buttons: { holder: "<nav>{{buttons}}</nav>", ok: "<button class='ok' tabindex='1'>{{ok}}</button>", cancel: "<button class='cancel' tabindex='2'>{{cancel}}</button>" },
            ...
            build: function (t) {
                ...
                return (
                    ("confirm" !== t.type && "prompt" !== t.type) || (e = this.dialogs.buttons.cancel + this.dialogs.buttons.ok),
